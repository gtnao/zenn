...
| 値  | ビット表現                                | 符号部 | 指数部         | 仮数部    |
| --- | ----------------------------------------- | ------ | -------------- | --------- |
| ∞   | `0111 1111 1000 0000 0000 0000 0000 0000` | +(`0`) | 0(`1111 1111`) | 0         |
| -∞  | `1111 1111 1000 0000 0000 0000 0000 0000` | -(`1`) | 0(`1111 1111`) | 0         |
| NaN | `X111 1111 1XXX XXXX XXXX XXXX XXXX XXXX` | 任意   | 0(`1111 1111`) | 0以外任意 |
